...
import { TrackProvider } from "./assets/context/TrackContext";
import { CurrentTrackProvider } from "./assets/context/CurrentTrackContext";
        ...
        <TrackProvider>
          <Routes>
            ...
            <Route path="/" element={<Layout />}>
              ...
              <Route
                path="show"
                element={<Navigate to="/show/5968" replace />}
              />
